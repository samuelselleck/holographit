...
# Look at it all!
# firefox rectangle-animation.gif test4-animation.gif icosahedron-animation.gif 
firefox icosahedron-anim.svg test4-anim.svg rect-anim.svg icosahedron-error.svg
